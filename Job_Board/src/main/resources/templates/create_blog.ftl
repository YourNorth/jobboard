        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    <h3>Create your own post for blog</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row cat_search">
                <div class="col-lg-3 col-md-4">
                    <div class="single_input">
                        <input type="text" autocomplete="off" id="postName" name="postName" placeholder="Post Name">
                    </div>
                    <p></p>
                </div>
                <div class="col-lg-3 col-md-8">
                    <div class="reset_btn">
                        <button  class="boxed-btn3 w-100" type="submit" onclick="return validateForm()">Create my post</button>
                    </div>
                    <p></p>
                </div>
