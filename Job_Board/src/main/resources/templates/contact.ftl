...
<section class="contact-section section_padding">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="/contact" method="post" id="contact1"
                      autocomplete="off">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="form-group mt-3">
                        <button type="submit" onclick="return validateForm1()" class="button button-contactForm btn_4 boxed-btn">Send Message</button>
                    </div>
                </form>
            </div>
            ...
            <script>
                function validateForm1() {
                    ...
                    if (message.value.length < 6 || message.value.length > 254) {
                        error += 'Message must be between 20 and 254 characters! \n';
                    }
                    if (name.value.length < 2 || name.value.length > 50) {
                        error += 'Name must be between 2 and 50 characters! \n';
                    }
                    if (subject.value.length < 4 || subject.value.length > 50) {
                        error += 'Subject name must be between 4 and 50 characters! \n';
                    }
                    if (error !== '') {
                        ...
                        let form = document.getElementById("contact1");
                        form.submit();
                    }
                }
            </script>
